...
/**
 * lessen_id: ユニークキー
 * lessen_caliculam_id: caliculam.caliculam_id
 * lessen_title: レッスンタイトル
 * lessen_pr_text: レッスンPR文
 * lessen_text: レッスン文
 * lessen_image: レッスン画像
 * created_at
 * updated_at
 * deleted_at
 */
class CreateLessenTable extends Migration
{
    ...
    public function up()
    {
        if (Schema::hasTable($this->table_name) === true) {
            ...
            Schema::create($this->table_name, function ($table) {
                ...
                $table->integer($this->table_name . "_caliculam_id");
